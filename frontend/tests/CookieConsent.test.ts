...
vi.stubGlobal('onUnmounted', (await import('vue')).onUnmounted)
...
const mountOptions = { stubs: { NuxtLink: NuxtLinkStub } }
...
describe('CookieConsent', () => {
  ...
  describe('visibility', () => {
    it('banner is hidden when localStorage.cookieConsent is "accepted"', async () => {
      ...
      const wrapper = mount(CookieConsent, { global: mountOptions })

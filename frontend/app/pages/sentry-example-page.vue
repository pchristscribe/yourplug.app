...
<template>
  ...
  <div>
    <main>
      ...
      <p class="description">
        Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://yourplug.sentry.io/issues/?project=4511577167101952">Issues Page</a>.
